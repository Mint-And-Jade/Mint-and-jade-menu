    ...
    <div>
        <header
            ...
            <div class="absolute right-6 bottom-4 flex items-center justify-end w-fit gap-6">
                <div v-if="isAuth" @click="this.$router.push('/dashboardweioruvwurqwervjoqwjiriowjoqrjvinwirjnbqwehtbnvwiptnipqwejnvtiopqwntiqwnipuhnvtuiqnt564tq68541t56qv1t561vtq56t41q')" class="text-xl font-bold text-black/50 cursor-pointer">
                Dashboard
                </div>
